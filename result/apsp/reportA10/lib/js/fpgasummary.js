...
var FPGAClockFreqSummary = function (pDiv, pProduct) {
    ...
    this.draw = function (pShow) {
        ...
        if (loop_attrJSON.hasOwnProperty('nodes')) {
            ...
            columns = {};
            let doublePumpWarning = "";
            if (hasDoublePumpedMem) {
                doublePumpWarning = " (Warning: Possible fmax degradation due to double pumped memory)";
            }
            columns[clockAttrName] = minClock + doublePumpWarning;
