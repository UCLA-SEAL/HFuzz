...
// SystemVerilog created from i_iord_bl_acl_c_zn2cl4sycl3ext5intel4pipein6detail12consumerimpli21loopbackwriteiopipeidilb0elm4ee6pipeideili4ee9m_storagee_pipe_channel_unnamed_k2_zts21loopbackwriteiopipeid6_k2_zts21loopbackwriteiopipeid0
...
module k2_ZTS21LoopBackWriteIOPipeID_i_iord_bl_0000opbackwriteiopipeid0 (
    ...
    // iord(EXTIFACE,4)
    assign iord_i_fifodata = in_iord_bl_acl_c_ZN2cl4sycl3ext5intel4pipeIN6detail12ConsumerImplI21LoopBackWriteIOPipeIDiLb0ELm4EE6PipeIDEiLi4EE9m_StorageE_pipe_channel_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_acl_c_ZN2cl4sycl3ext5intel4pipeIN6detail12ConsumerImplI21LoopBackWriteIOPipeIDiLb0ELm4EE6PipeIDEiLi4EE9m_StorageE_pipe_channel_i_fifovalid;
    ...
    hld_iord #(
        ...
        .i_fifodata(in_iord_bl_acl_c_ZN2cl4sycl3ext5intel4pipeIN6detail12ConsumerImplI21LoopBackWriteIOPipeIDiLb0ELm4EE6PipeIDEiLi4EE9m_StorageE_pipe_channel_i_fifodata),
    ...
    assign out_iord_bl_acl_c_ZN2cl4sycl3ext5intel4pipeIN6detail12ConsumerImplI21LoopBackWriteIOPipeIDiLb0ELm4EE6PipeIDEiLi4EE9m_StorageE_pipe_channel_o_fifoalmost_full = iord_o_fifoalmost_full;

    // sync_out(GPOUT,10)@20000000
    assign out_o_stall = iord_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,12)
    assign out_iord_bl_acl_c_ZN2cl4sycl3ext5intel4pipeIN6detail12ConsumerImplI21LoopBackWriteIOPipeIDiLb0ELm4EE6PipeIDEiLi4EE9m_StorageE_pipe_channel_o_fifoready = iord_o_fifoready;
