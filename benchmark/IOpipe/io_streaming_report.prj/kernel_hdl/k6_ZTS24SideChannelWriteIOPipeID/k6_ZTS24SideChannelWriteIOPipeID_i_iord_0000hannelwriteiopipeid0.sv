...
// SystemVerilog created from i_iord_bl_acl_c_zn2cl4sycl3ext5intel4pipein6detail12consumerimpli24sidechannelwriteiopipeidilb0elm0ee6pipeideili0ee9m_storagee_pipe_channel_unnamed_k6_zts24sidechannelwriteiopipeid6_k6_zts24sidechannelwriteiopipeid0
...
module k6_ZTS24SideChannelWriteIOPipeID_i_iord_0000hannelwriteiopipeid0 (
    ...
    // iord(EXTIFACE,4)
    assign iord_i_fifodata = in_iord_bl_acl_c_ZN2cl4sycl3ext5intel4pipeIN6detail12ConsumerImplI24SideChannelWriteIOPipeIDiLb0ELm0EE6PipeIDEiLi0EE9m_StorageE_pipe_channel_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_acl_c_ZN2cl4sycl3ext5intel4pipeIN6detail12ConsumerImplI24SideChannelWriteIOPipeIDiLb0ELm0EE6PipeIDEiLi0EE9m_StorageE_pipe_channel_i_fifovalid;
    ...
    hld_iord #(
        ...
        .i_fifodata(in_iord_bl_acl_c_ZN2cl4sycl3ext5intel4pipeIN6detail12ConsumerImplI24SideChannelWriteIOPipeIDiLb0ELm0EE6PipeIDEiLi0EE9m_StorageE_pipe_channel_i_fifodata),
    ...
    assign out_iord_bl_acl_c_ZN2cl4sycl3ext5intel4pipeIN6detail12ConsumerImplI24SideChannelWriteIOPipeIDiLb0ELm0EE6PipeIDEiLi0EE9m_StorageE_pipe_channel_o_fifoalmost_full = iord_o_fifoalmost_full;

    // sync_out(GPOUT,10)@20000000
    assign out_o_stall = iord_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,12)
    assign out_iord_bl_acl_c_ZN2cl4sycl3ext5intel4pipeIN6detail12ConsumerImplI24SideChannelWriteIOPipeIDiLb0ELm0EE6PipeIDEiLi0EE9m_StorageE_pipe_channel_o_fifoready = iord_o_fifoready;
