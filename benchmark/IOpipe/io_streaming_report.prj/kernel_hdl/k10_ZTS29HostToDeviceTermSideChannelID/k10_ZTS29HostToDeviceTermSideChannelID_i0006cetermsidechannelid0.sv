...
// SystemVerilog created from i_iowr_bl_acl_c_zn2cl4sycl3ext5intel4pipein6detail12producerimpli29hosttodevicetermsidechannelidclb0elm1ee6pipeidecli1ee9m_storagee_pipe_channel_unnamed_k10_zts29hosttodevicetermsidechannelid7_k10_zts29hosttodevicetermsidechannelid0
...
module k10_ZTS29HostToDeviceTermSideChannelID_i0006cetermsidechannelid0 (
    ...
    assign iowr_i_fifoready = in_iowr_bl_acl_c_ZN2cl4sycl3ext5intel4pipeIN6detail12ProducerImplI29HostToDeviceTermSideChannelIDcLb0ELm1EE6PipeIDEcLi1EE9m_StorageE_pipe_channel_i_fifoready;
    ...
    assign out_iowr_bl_acl_c_ZN2cl4sycl3ext5intel4pipeIN6detail12ProducerImplI29HostToDeviceTermSideChannelIDcLb0ELm1EE6PipeIDEcLi1EE9m_StorageE_pipe_channel_o_fifodata = iowr_o_fifodata;

    // sync_out(GPOUT,8)@20000000
    assign out_o_stall = iowr_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,11)
    assign out_iowr_bl_acl_c_ZN2cl4sycl3ext5intel4pipeIN6detail12ProducerImplI29HostToDeviceTermSideChannelIDcLb0ELm1EE6PipeIDEcLi1EE9m_StorageE_pipe_channel_o_fifovalid = iowr_o_fifovalid;
