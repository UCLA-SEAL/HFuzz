...
// SystemVerilog created from i_iowr_nb_acl_c_zn2cl4sycl3ext5intel4pipein6detail12consumerimpli26devicetohosttsidechannelidilb0elm8ee6pipeideili8ee9m_storagee_pipe_channel_unnamed_k3_zts21sidechannelmainkernel17_k3_zts21sidechannelmainkernel0
...
module k3_ZTS21SideChannelMainKernel_i_iowr_nb_0001dechannelmainkernel0 (
    input wire [0:0] in_iowr_nb_acl_c_ZN2cl4sycl3ext5intel4pipeIN6detail12ConsumerImplI26DeviceToHostTSideChannelIDiLb0ELm8EE6PipeIDEiLi8EE9m_StorageE_pipe_channel_i_fifoready,
    output wire [31:0] out_iowr_nb_acl_c_ZN2cl4sycl3ext5intel4pipeIN6detail12ConsumerImplI26DeviceToHostTSideChannelIDiLb0ELm8EE6PipeIDEiLi8EE9m_StorageE_pipe_channel_o_fifodata,
    output wire [0:0] out_iowr_nb_acl_c_ZN2cl4sycl3ext5intel4pipeIN6detail12ConsumerImplI26DeviceToHostTSideChannelIDiLb0ELm8EE6PipeIDEiLi8EE9m_StorageE_pipe_channel_o_fifovalid,
    input wire [0:0] in_i_stall,
    output wire [0:0] out_o_stall,
    input wire [0:0] in_first_cleanup_xor_or16,
    ...
    // iowr_nb(EXTIFACE,6)@3
    assign iowr_nb_i_data = in_i_data;
    assign iowr_nb_i_endofpacket = GND_q;
    assign iowr_nb_i_fifoready = in_iowr_nb_acl_c_ZN2cl4sycl3ext5intel4pipeIN6detail12ConsumerImplI26DeviceToHostTSideChannelIDiLb0ELm8EE6PipeIDEiLi8EE9m_StorageE_pipe_channel_i_fifoready;
    assign iowr_nb_i_fifosize = c32_0_q;
    assign iowr_nb_i_packetempty = c32_0_q;
    assign iowr_nb_i_predicate = in_first_cleanup_xor_or16;
    ...
    assign out_iowr_nb_acl_c_ZN2cl4sycl3ext5intel4pipeIN6detail12ConsumerImplI26DeviceToHostTSideChannelIDiLb0ELm8EE6PipeIDEiLi8EE9m_StorageE_pipe_channel_o_fifodata = iowr_nb_o_fifodata;
    assign out_iowr_nb_acl_c_ZN2cl4sycl3ext5intel4pipeIN6detail12ConsumerImplI26DeviceToHostTSideChannelIDiLb0ELm8EE6PipeIDEiLi8EE9m_StorageE_pipe_channel_o_fifovalid = iowr_nb_o_fifovalid;
