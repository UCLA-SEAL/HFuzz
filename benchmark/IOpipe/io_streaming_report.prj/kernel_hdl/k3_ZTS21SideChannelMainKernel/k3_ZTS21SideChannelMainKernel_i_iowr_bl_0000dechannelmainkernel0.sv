...
// SystemVerilog created from i_iowr_bl_acl_c_zn2cl4sycl3ext5intel4pipein6detail12consumerimpli24sidechannelwriteiopipeidilb0elm0ee6pipeideili0ee9m_storagee_pipe_channel_unnamed_k3_zts21sidechannelmainkernel23_k3_zts21sidechannelmainkernel0
...
module k3_ZTS21SideChannelMainKernel_i_iowr_bl_0000dechannelmainkernel0 (
    input wire [0:0] in_iowr_bl_acl_c_ZN2cl4sycl3ext5intel4pipeIN6detail12ConsumerImplI24SideChannelWriteIOPipeIDiLb0ELm0EE6PipeIDEiLi0EE9m_StorageE_pipe_channel_i_fifoready,
    output wire [31:0] out_iowr_bl_acl_c_ZN2cl4sycl3ext5intel4pipeIN6detail12ConsumerImplI24SideChannelWriteIOPipeIDiLb0ELm0EE6PipeIDEiLi0EE9m_StorageE_pipe_channel_o_fifodata,
    input wire [0:0] in_i_stall,
    output wire [0:0] out_o_stall,
    input wire [0:0] in_c0_exe5,
    input wire [31:0] in_i_data,
    input wire [0:0] in_i_valid,
    output wire [0:0] out_iowr_bl_acl_c_ZN2cl4sycl3ext5intel4pipeIN6detail12ConsumerImplI24SideChannelWriteIOPipeIDiLb0ELm0EE6PipeIDEiLi0EE9m_StorageE_pipe_channel_o_fifovalid,
    ...
    assign iowr_i_fifoready = in_iowr_bl_acl_c_ZN2cl4sycl3ext5intel4pipeIN6detail12ConsumerImplI24SideChannelWriteIOPipeIDiLb0ELm0EE6PipeIDEiLi0EE9m_StorageE_pipe_channel_i_fifoready;
    assign iowr_i_fifosize = c32_0_q;
    assign iowr_i_packetempty = c32_0_q;
    assign iowr_i_predicate = in_c0_exe5;
    ...
    assign out_iowr_bl_acl_c_ZN2cl4sycl3ext5intel4pipeIN6detail12ConsumerImplI24SideChannelWriteIOPipeIDiLb0ELm0EE6PipeIDEiLi0EE9m_StorageE_pipe_channel_o_fifodata = iowr_o_fifodata;

    // sync_out(GPOUT,8)@20000000
    assign out_o_stall = iowr_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,11)
    assign out_iowr_bl_acl_c_ZN2cl4sycl3ext5intel4pipeIN6detail12ConsumerImplI24SideChannelWriteIOPipeIDiLb0ELm0EE6PipeIDEiLi0EE9m_StorageE_pipe_channel_o_fifovalid = iowr_o_fifovalid;
