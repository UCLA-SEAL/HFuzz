...
// SystemVerilog created from i_iowr_bl_acl_c_zn2cl4sycl3ext5intel4pipein6detail12producerimpli23sidechannelreadiopipeidilb0elm0ee6pipeideili0ee9m_storagee_pipe_channel_unnamed_k5_zts23sidechannelreadiopipeid7_k5_zts23sidechannelreadiopipeid0
...
module k5_ZTS23SideChannelReadIOPipeID_i_iowr_b0000channelreadiopipeid0 (
    ...
    assign iowr_i_fifoready = in_iowr_bl_acl_c_ZN2cl4sycl3ext5intel4pipeIN6detail12ProducerImplI23SideChannelReadIOPipeIDiLb0ELm0EE6PipeIDEiLi0EE9m_StorageE_pipe_channel_i_fifoready;
    ...
    assign out_iowr_bl_acl_c_ZN2cl4sycl3ext5intel4pipeIN6detail12ProducerImplI23SideChannelReadIOPipeIDiLb0ELm0EE6PipeIDEiLi0EE9m_StorageE_pipe_channel_o_fifodata = iowr_o_fifodata;

    // sync_out(GPOUT,8)@20000000
    assign out_o_stall = iowr_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,11)
    assign out_iowr_bl_acl_c_ZN2cl4sycl3ext5intel4pipeIN6detail12ProducerImplI23SideChannelReadIOPipeIDiLb0ELm0EE6PipeIDEiLi0EE9m_StorageE_pipe_channel_o_fifovalid = iowr_o_fifovalid;
