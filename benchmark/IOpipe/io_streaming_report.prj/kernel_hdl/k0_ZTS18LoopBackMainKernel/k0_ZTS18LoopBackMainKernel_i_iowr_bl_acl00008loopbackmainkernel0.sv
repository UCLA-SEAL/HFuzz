...
// SystemVerilog created from i_iowr_bl_acl_c_zn2cl4sycl3ext5intel4pipein6detail12consumerimpli21loopbackwriteiopipeidilb0elm4ee6pipeideili4ee9m_storagee_pipe_channel_unnamed_k0_zts18loopbackmainkernel7_k0_zts18loopbackmainkernel0
...
module k0_ZTS18LoopBackMainKernel_i_iowr_bl_acl00008loopbackmainkernel0 (
    ...
    assign iowr_i_fifoready = in_iowr_bl_acl_c_ZN2cl4sycl3ext5intel4pipeIN6detail12ConsumerImplI21LoopBackWriteIOPipeIDiLb0ELm4EE6PipeIDEiLi4EE9m_StorageE_pipe_channel_i_fifoready;
    assign iowr_i_fifosize = c32_0_q;
    assign iowr_i_packetempty = c32_0_q;
    assign iowr_i_predicate = in_c0_exe3;
    ...
    assign out_iowr_bl_acl_c_ZN2cl4sycl3ext5intel4pipeIN6detail12ConsumerImplI21LoopBackWriteIOPipeIDiLb0ELm4EE6PipeIDEiLi4EE9m_StorageE_pipe_channel_o_fifodata = iowr_o_fifodata;

    // sync_out(GPOUT,8)@20000000
    assign out_o_stall = iowr_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,11)
    assign out_iowr_bl_acl_c_ZN2cl4sycl3ext5intel4pipeIN6detail12ConsumerImplI21LoopBackWriteIOPipeIDiLb0ELm4EE6PipeIDEiLi4EE9m_StorageE_pipe_channel_o_fifovalid = iowr_o_fifovalid;

    // dupName_0_sync_out_x(GPOUT,12)@5
